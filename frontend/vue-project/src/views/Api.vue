<template>
  <div>
    <div class="control-panel p-5">
      <button
        @click="downloadData"
        class="btn btn-info m-2 control-panel-btn text-white"
      >
        Stiahni
      </button>
      ...
      <div class="my-4">
        ...
        <button
          @click="deleteData"
          class="btn btn-danger my-2 control-panel-btn w-100"
        >
          Vymaž
        </button>
      </div>
